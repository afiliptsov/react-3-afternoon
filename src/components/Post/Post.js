...
<section className="Post__parent" onClick={this.hideMasterMenu}>
        ...
        */}
        <div className="Post__content">
          ...
          editing ? <Edit updatePostFn={this.props.updatePostFn} id={this.props.id} text={this.props.text} hideEdit={this.hideEdit} /> : <span className="Post__text">
              {this.props.text}
            </span>}
        </div>
